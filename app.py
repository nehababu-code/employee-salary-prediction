...
def load_and_train_model():
    ...
    # Save original values for dropdowns
    original_values = {}
    ...
    return model, label_encoders, original_values

# Function to build the prediction form
def prediction_form(model, label_encoders, original_values):
...
def main():
    ...
    if st.session_state.page == 'home':
        ...
        if os.path.exists("banner.jpg"):
            ...
            st.info("👋 Upload a file named `banner.jpg` in the app folder to display the welcome image.")
        ...
        model, label_encoders, original_values = load_and_train_model()
        prediction_form(model, label_encoders, original_values)
